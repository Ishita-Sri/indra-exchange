...
const Home = () => {
  ...
  return (
    <Scrollbar ref={scrollbar} options={options}>
      <div className="landing-page">
        ...
        <div class="gallery-container">
          <div class="image-box">
            <img src={one} alt="Descriptive Alt Text" />
            <div class="follower">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
          ...
          <div class="image-box">
            <img src={two} alt="Descriptive Alt Text" />
            <div class="follower">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
          ...
          <div class="image-box">
            <img src={three} alt="Descriptive Alt Text" />
            <div class="follower">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
          ...
          <div class="image-box">
            <img src={four} alt="Descriptive Alt Text" />
            <div class="follower">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
          ...
          <div class="image-box">
            <img src={five} alt="Descriptive Alt Text" />
            <div class="follower">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
          ...
          <div class="image-box">
            <img src={six} alt="Descriptive Alt Text" />
            <div class="follower">
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="image-box">
            <img src={sev} alt="Descriptive Alt Text" />
            <div class="follower">
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="image-box">
            <img src={eig} alt="Descriptive Alt Text" />
            <div class="follower">
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="why-join">
          ...
          <div className="join-right">
            ...
            <div className="right-down">
              ...
              documentation needs. 24/7 dedicated team to back up your queries,
              be it creating an ID or withdrawal request.
            </div>
          </div>
        </div>
        ...
        <div className="lower-banners">
          ...
          <div className="ban-2">
            ...
            prizes. We offer the best odds on betting involving a wide variety
            of sports, cricket included. Get your online betting ID now!
          </div>
        </div>
        ...
        <div className="lower-banners">
          ...
          <div className="ban-2">
            ...
            options by providing you the secure online cricket ID portal. You
            can recreate the excitement of a trip to the casino in the comfort
            of your own home with one of our 1500 casino games or one of our 200
            Indian casino games.
          </div>
        </div>
        <br />
        ...
        <div className="lower-banners">
          ...
          <div className="ban-2">
            ...
            that our website is completely above board in every way. When it
            comes to gaming in India, you can rely on our website and our online
            betting ID portal. At TigerExch, your privacy and protection are our
            highest concerns, so you can rest easy knowing that you are in
            capable hands.
          </div>
        </div>
          ...
          <div className="footer-content">
            <div className="footer-content-2" style={{ width: "75%" }}>
              ...
              <div className="footer-1">
                Play exciting games win more prize's
              </div>
