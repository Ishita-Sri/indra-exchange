      ...
      {/* <div className="banner-cric">
        ...
        <div className="banner-right">
          <div className="banner-one">
            <div className="text-1"> 26 Oct, 09:30</div>
            <div className="text-2"> Sydney Thunder</div>
            <div className="text-2"> Melbourne Renegades WBB</div>
          </div>
          <div className="banner-one">
            <div className="text-1"> 1:2</div>
            <div className="text-2"> 2.04</div>
      ...
      <div className="footer">
        ...
        <div className="footer-content">
          <div className="footer-content-2" style={{ width: "80%" }}>
            ...
            <div style={{ marginBottom: "55px", display: "flex", gap: "30px" }}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
                height="28"
              ...
              >
                <path
                  d="M19.8333 4.08327C19.8333 3.92856 19.7719 3.78019 19.6625 3.67079C19.5531 3.5614 19.4047 3.49994 19.25 3.49994H16.3333C14.8646 3.42678 13.4267 3.9379 12.3337 4.92162C11.2407 5.90534 10.5814 7.28169 10.5 8.74994V11.8999H7.58333C7.42862 11.8999 7.28025 11.9614 7.17085 12.0708C7.06146 12.1802 7 12.3286 7 12.4833V15.5166C7 15.6713 7.06146 15.8197 7.17085 15.9291C7.28025 16.0385 7.42862 16.0999 7.58333 16.0999H10.5V23.9166C10.5 24.0713 10.5615 24.2197 10.6709 24.3291C10.7803 24.4385 10.9286 24.4999 11.0833 24.4999H14.5833C14.738 24.4999 14.8864 24.4385 14.9958 24.3291C15.1052 24.2197 15.1667 24.0713 15.1667 23.9166V16.0999H18.2233C18.3531 16.1018 18.4797 16.0604 18.5832 15.9822C18.6868 15.904 18.7613 15.7936 18.795 15.6683L19.635 12.6349C19.6582 12.5487 19.6613 12.4584 19.6441 12.3708C19.6269 12.2832 19.5898 12.2007 19.5357 12.1297C19.4816 12.0587 19.412 12.0011 19.3321 11.9613C19.2522 11.9214 19.1643 11.9004 19.075 11.8999H15.1667V8.74994C15.1957 8.46116 15.3313 8.19357 15.547 7.99942C15.7628 7.80526 16.0431 7.69849 16.3333 7.69994H19.25C19.4047 7.69994 19.5531 7.63848 19.6625 7.52909C19.7719 7.41969 19.8333 7.27132 19.8333 7.11661V4.08327Z"
                  fill="white"
                />
              </svg>
              <svg
